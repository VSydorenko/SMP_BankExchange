...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Наименование = НСтр("ru='Обработка выписки банка Аваль';uk='Обробка виписки банка Аваль'");
	ПараметрыРегистрации.Информация = НСтр("ru='Обработка формата загрузки данных украинского банка Аваль';uk='Обробка формату завантаження даних українського банка Аваль'");
...
&НаСервере
Функция ЗагрузитьБух(ДокументыДляИмпорта,
