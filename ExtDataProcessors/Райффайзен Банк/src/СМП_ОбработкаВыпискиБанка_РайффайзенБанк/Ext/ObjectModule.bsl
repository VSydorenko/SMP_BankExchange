...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Наименование = НСтр("ru='Обработка выписки банка Райффайзен Банк';uk='Обробка виписки банка Райффайзен Банк'");
	ПараметрыРегистрации.Информация = НСтр("ru='Обработка формата загрузки данных украинского банка Райффайзен Банк';uk='Обробка формату завантаження даних українського банка Райффайзен Банк'");
...
Функция Выгрузить_Бух(Параметры) Экспорт
	...
	Для Каждого Строка из Параметры.ПлатежныеДокументы Цикл
		...
		Файл.ДобавитьСтроку("NUM_DOC="			+ Формат(Строка.Номер, "ЧЦ=10;ЧГ=0"));
		...
		Файл.ДобавитьСтроку("PAYMENT_DETAILS="	+ Лев(СтрЗаменить(Строка.НазначениеПлатежа, Символ(160), Символ(32)), 160));
		Файл.ДобавитьСтроку("");
