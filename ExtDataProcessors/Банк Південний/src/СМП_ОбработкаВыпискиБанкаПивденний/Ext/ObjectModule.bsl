...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	//ПараметрыРегистрации.Вставить("Наименование",НСтр("ru='Обработка выписки банка Південний';uk='Обробка виписки банка Південний'"));
	//ПараметрыРегистрации.Вставить("Версия", "1.1");
	//ПараметрыРегистрации.Вставить("БезопасныйРежим", ложь);
	//ПараметрыРегистрации.Вставить("Информация",НСтр("ru='Обработка формата загрузки данных украинского банка Південний';uk='Обробка формату завантаження даних українського банка Південний'"));
