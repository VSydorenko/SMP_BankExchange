...
Процедура ЗапроситьЭлектроннуюВыпискуБанка(Команда)
	...
	СМП_ЗаполнитьДокументыНаИмпортПоСправочнику(Объект.ОбработкаПротокола, Объект.ОТП);
...
&НаСервере
Процедура СМП_ЗаполнитьДокументыНаИмпортПоСправочнику(ЭлСправочника, ОТП = "")                         
