...
Функция ПолучитьТокен(УчетнаяЗаписьБанка, ОТП)
	...
	Если (Не ЗначениеЗаполнено(ДанныеАутентификации.СрокДействияТокена) ИЛИ ДанныеАутентификации.СрокДействияТокена <= ТекущаяДата()) И ЗначениеЗаполнено(ОТП) Тогда
