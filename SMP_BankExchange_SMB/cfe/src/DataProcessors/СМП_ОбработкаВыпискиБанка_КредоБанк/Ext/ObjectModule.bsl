...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Наименование = НСтр("ru='Обработка выписки банка КредоБанк';uk='Обробка виписки банка КредоБанк'");
	ПараметрыРегистрации.Информация = НСтр("ru='Обработка формата загрузки данных украинского банка КредоБанк';uk='Обробка формату завантаження даних українського банка КредоБанк'");
...
Функция ЗагрузитьСекциюДокументаXMLROW(ДокументыДляИмпорта, ФайлXML, ИмпортЗагружаемые)
	...
	НоваяСтрокаДокументов.Дата				= ФайлXML.ПолучитьАтрибут("DOCUMENTDATE") + " " + Сред(ФайлXML.ПолучитьАтрибут("BOOKEDDATE"), 12, 8) ;
