	...
	Если Регламент Тогда
		...
		Если Данные <> Неопределено Тогда
			...
			Если СокрЛП(Данные["ИДТранзакции"]) <> "" Тогда
				Запрос = Запрос + "&followId=" + ?(НомерСтраницы <> Неопределено, НомерСтраницы, Данные["ИДТранзакции"]);
			КонецЕсли;
		Иначе
...
Процедура Прочитать(СтруктураПараметров, УчетнаяЗапись, ЭтоРеглЗадание = Ложь) Экспорт
	
	сПараметрыДоступа = СтруктураПараметров.ПараметрыДоступа;
	...
	ПрочитатьВыписки(
		...
		ДокументыКИмпорту, 
		сПараметрыДоступа.ИД, 
		сПараметрыДоступа.Токен, 
		ЭтоРеглЗадание);
