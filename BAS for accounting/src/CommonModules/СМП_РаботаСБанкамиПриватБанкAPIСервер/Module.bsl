...
Процедура Прочитать(СтруктураПараметров, id, token) Экспорт
	
	//Загрузить_Бух(ДокументыДляИмпорта,
	...
	ПрочитатьВыписки(СтруктураПараметров.НачПериода, КонецДня(СтруктураПараметров.КонПериода),СтруктураПараметров.БанковскийСчет,ДокументыКИмпорту, id, token);
