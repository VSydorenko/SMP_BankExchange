...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.СоздаватьНенайденныеЭлементы.Видимость = Объект.ИспользоватьРегламентноеЗадание;
	...
	Элементы.ПроводитьПриЗагрузкеПоступлениеНаРасчетныйСчет.Видимость = Объект.ИспользоватьРегламентноеЗадание;
	Элементы.ПроводитьПриЗагрузкеСписаниеСРасчетногоСчета.Видимость = Объект.ИспользоватьРегламентноеЗадание;
