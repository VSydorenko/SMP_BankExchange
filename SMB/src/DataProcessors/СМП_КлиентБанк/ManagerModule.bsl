...
Функция СоздатьНовогоКонтрагентаПриЗагрузке(ТаблицаОбъектовСозданныхПриЗагрузке, ДанныеСтроки, ДанныеОбъекта)
	...
	Иначе
		...
		ВидКонтрагента = ?(СтрДлина(СокрЛП(КПП)) = 10, Перечисления.ВидыКонтрагентов.ИндивидуальныйПредприниматель, Перечисления.ВидыКонтрагентов.ЮридическоеЛицо);
...
Функция НайтиБанкПоМФОИСоздать(МФО) Экспорт
	...
	Дерево = Справочники.Банки.СМП_ПолучитьДеревоКлассификатора();
