...
//
Функция ПрочитатьJSONМодуль(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
...
//
Функция ЗаписатьJSONМодуль(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
