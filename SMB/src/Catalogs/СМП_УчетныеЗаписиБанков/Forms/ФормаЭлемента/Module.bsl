...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ИД.Видимость = ЭтоПриватБанкAPI;
	...
	Элементы.СоздатьНовогоКонтрагентаПриЗагрузкеВыписки.Доступность = Объект.ИспользоватьРегламентныеЗадания;
	Элементы.ГруппаДоступаДляНовыхКонтрагентов.Доступность = Объект.ИспользоватьРегламентныеЗадания;
    Элементы.ГруппаМоноВебХук.Видимость = ЭтоМоноБанкAPI;
	Элементы.ДекорацияПолучитьТокенМоно.Видимость = ЭтоМоноБанкAPI;
	...
	//	ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Не обнаружена лицензия на использование интеграции с банком ПриватБанк средствами API!';
