...
Функция ЗаполнитьДокументыНаИмпорт(ИмпортТекстДляРазбора)
	...
	Операция = ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, "Обработки.КлиентБанк.РазобратьБанковскуюВыписку", КонтекстФормы);
	Возврат Операция;
	...
	Для каждого СтрокаДокумента Из Объект.Загрузка Цикл
		...
		Если ТипЗнч(СтрокаДокумента.Контрагент) = Тип("Строка")
		 ИЛИ ТипЗнч(СтрокаДокумента.СчетКонтрагента) = Тип("Строка") Тогда
			...
			Обработки.КлиентБанк.СписокНенайденных(СтрокаДокумента, Объект.БанковскийСчет, ВременнаяТаблицаКонтрагентов, КоличествоНеНайденныхКонтрагентов, КоличествоНеНайденныхРСчетов);
...
Процедура ОткрытьФормуРедактированияНазначения(ДанныеСтроки)
	...
	ОткрытьФорму("Обработка.КлиентБанк.Форма.РедактированиеНазначения", ПараметрыФормы, , , , , ОписаниеОповещения,
...
Процедура ОткрытьФормуРедактированияСтатьиДДС(ДанныеСтроки)
	...
	ОткрытьФорму("Обработка.КлиентБанк.Форма.РедактированиеСтатьиДДС", ПараметрыФормы, , , , , ОписаниеОповещения,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Функция ДлительнаяОперацияЗагрузкиВыписки()
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияФункции(УникальныйИдентификатор);
	Операция = ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, "Обработки.КлиентБанк.Загрузить", КонтекстФормы);
