...
Функция ПосмотретьВОтдельномОкнеПлатежноеПоручениеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_ПлатежноеПоручение");
...
Функция ПосмотретьВОтдельномОкнеПлатежноеПоручениеНеПрямыеРасчетыНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_ПлатежноеПоручениеНеПрямыеРасчеты");
...
Функция ПосмотретьВОтдельномОкнеБанковскийОрдерНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_БанковскийОрдер");
...
Функция ПосмотретьВОтдельномОкнеПлатежноеТребованиеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_ПлатежноеТребование");
...
Функция ПосмотретьВОтдельномОкнеИнкассовоеПоручениеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_ИнкассовоеПоручение");
...
Функция ПосмотретьВОтдельномОкнеАккредитивНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_Аккредитив");
...
Функция ПосмотретьВОтдельномОкнеОперациюНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.СМП_КлиентБанк.ПФ_MXL_НеНайденаОперация");
